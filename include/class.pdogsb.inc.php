...
/**
 * Classe d'accès aux données contenue sur la base de données
...
class PdoGsb{   	
		...
		//Informations sur la base de données
      	private static $serveur='mysql:host=mysql.alwaysdata.com';
      	private static $bdd='dbname=ludovicrecco_gsbfrais2';         	    
		private static $user='122117' ;    		
      	private static $mdp='ukulele' ;	
		/////////////////////////////
...
/**
 * met à jour le montant validé de la table ficheFrais
 * pour le mois et le visiteur concerné
 
 * @param $idVisiteur 
 * @param $mois sous la forme aaaamm
 * @param $montantValide montant validé
*/
 ...
 * @param $idVisiteur 
 * @param string $etatFiche (opyionnel) Etat des fiches recherchées. (ex 'VA', 'RB')
...
*/
	public function getLesMoisDisponibles($idVisiteur, $etatFiche = ''){
        ...
        /**
         * Retourne un tableau contenant tous les visiteurs de la base de données
 ...
 */
	...
	public function majEtatFicheFrais($idVisiteur,$mois,$etat){
        ...
        /**
 * Modifie l'état des frais Forfaits
 ...
 */
	...
	public function majEtatFraisForfait($idVisiteur,$mois,$etat){
        ...
        /**
         * Modifie l'etat de tous les hors forfait a la fois pour le mois et visiteur selectionné
